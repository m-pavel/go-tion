...
func TestRequest01(t *testing.T) {
	...
	bt := BuildRequest(false, true, true, 1, 2, 23)
...
func TestRequest02(t *testing.T) {
	...
	bt := BuildRequest(true, true, true, 1, 2, 14)
	if !reflect.DeepEqual(expct, bt) {
		t.Fatal(bt)
	}
}
...
func TestRequest03(t *testing.T) {
	...
	bt := BuildRequest(true, true, true, 1, 0, 18)
	if !reflect.DeepEqual(expct, bt) {
		t.Fatal(bt)
	}
}
...
func TestRequest04(t *testing.T) {
	...
	bt := BuildRequest(true, true, false, 1, 1, 18)
	if !reflect.DeepEqual(expct, bt) {
		t.Fatal(bt)
	}
}
